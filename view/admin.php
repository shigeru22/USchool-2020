            ...
            <tbody>
                <?php
                    ...
                    while($row = $result->fetch_assoc()){
                        ...
                        echo "<td><a href=\"../view?id=" . $row["user_id"] . "\"><button class=\"btn mr-2 text-white\" style=\"background-color: #009900;\">View</button></a><a href=\"../delete?id=" . $row["user_id"] . "\"><button class=\"btn btn-danger\">Delete</button></td></a>";
                    }
                ?>
            </tbody>
        </table>
